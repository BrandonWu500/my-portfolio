// icon:jirasoftware | Simple Icons https://simpleicons.org | SimpleIcons.org
import * as React from 'react';

function IconJirasoftware(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="currentColor"
...
export default IconJirasoftware;
